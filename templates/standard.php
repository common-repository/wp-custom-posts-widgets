<?php
/**
 * Standard DTLWP posts widget template
 *
 * @version     2.0.0
 */
?>
...
<?php if ($instance['before_posts']) : ?>
  <div class="dtlwcpw-before">
    <?php echo wpautop($instance['before_posts']); ?>
  </div>
<?php endif; ?>

<div class="dtlwcpw-posts hfeed">

  <?php if ($dtlwcpw_query->have_posts()) : ?>

      <?php while ($dtlwcpw_query->have_posts()) : $dtlwcpw_query->the_post(); ?>
            ...
            <?php if ($instance['show_date'] || $instance['show_author'] || $instance['show_comments']) : ?>
              ...
              <div class="entry-meta">
                ...
                <?php if ($instance['show_date'] && $instance['show_author']) : ?>
                  <span class="sep"><?php _e('|', 'dtlwcpw'); ?></span>
                <?php endif; ?>

                <?php if ($instance['show_author']) : ?>
                  <span class="author vcard">
                    <?php echo __('By', 'dtlwcpw'); ?>
                ...
                <?php if ($instance['show_comments']) : ?>
                  <a class="comments" href="<?php comments_link(); ?>">
                    <?php comments_number(__('No comments', 'dtlwcpw'), __('One comment', 'dtlwcpw'), __('% comments', 'dtlwcpw')); ?>
                  </a>
                <?php endif; ?>
          ...
          <footer>
            ...
            ?>
              <div class="entry-categories">
                <strong class="entry-cats-label"><?php _e('Posted in', 'dtlwcpw'); ?>:</strong>
            ...
            ?>
              <div class="entry-tags">
                <strong class="entry-tags-label"><?php _e('Tagged', 'dtlwcpw'); ?>:</strong>
  ...
  <?php else : ?>
    ...
    <p class="dtlwcpw-not-found">
      <?php _e('No posts found.', 'dtlwcpw'); ?>
    </p>
