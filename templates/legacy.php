    ...
    <li class="<?php echo ($post->ID == $current_post_id && is_single())?'current-post-item':'' ?>">
      ...
      <div class="dtlwcpw-content">
        ...
        <?php if ($instance['show_author']) : ?>
          <p class="post-author">
            <span class="post-author-label"><?php _e('By', 'dtlwcpw'); ?>:</span>
        ...
        <?php if ($instance['show_comments']) : ?>
          <p class="post-comments">
            <?php comments_number(__('No responses', 'dtlwcpw'), __('One response', 'dtlwcpw'), __('% responses', 'dtlwcpw')); ?>
          </p>
        <?php endif; ?>
        ...
        ?>
          <p class="post-cats">
            <span class="post-cats-label"><?php _e('Categories', 'dtlwcpw'); ?>:</span>
        ...
        ?>
          <p class="post-tags">
            <span class="post-tags-label"><?php _e('Tags', 'dtlwcpw'); ?>:</span>
...
<?php else : ?>
  ...
  <p><?php _e('No posts found.', 'dtlwcpw'); ?></p>
